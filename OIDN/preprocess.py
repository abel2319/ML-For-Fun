...
#---------------------------------------------Abel----------------------------------------
    # D'abord déterminer la taille cible en chargeant l'image target
    target_image_full, _ = load_image_features(os.path.join(input_dir, target_name), target_features)
    target_size = target_image_full.shape[:2]
#---------------------------------abel-------------------------------------------------

    # Load the target image
    print(target_name)
    target_image, _ = load_image_features(os.path.join(input_dir, target_name), target_features, target_size=target_size)
    ...
    for input_name in input_names:
      # Load the image
      print(input_name)
      input_image, _ = load_image_features(os.path.join(input_dir, input_name), input_features, target_size=target_size)
