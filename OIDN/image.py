...
def load_image(filename, num_channels=None, target_size=None):
  ...
  #----------------------------------------Abel----------------------------------------------
  # Redimensionner si une taille cible est spécifiée
  if target_size is not None and (image.shape[0] != target_size[0] or image.shape[1] != target_size[1]):
      from skimage.transform import resize
      image = resize(image, (target_size[0], target_size[1], image.shape[2]), preserve_range=True)
  #--------------------------------------------------------------------------------------------
